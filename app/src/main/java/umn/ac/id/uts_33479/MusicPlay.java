...
public class MusicPlay extends  AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        song_name.setText(listSongs.get(position));
        artist_name.setText(listSongs.get(position));
    ...
    private void prevBtnClicked() {
        if(mediaPlayer.isPlaying()){
            ...
            uri = Uri.parse(listSongs.get(position));
    ...
    private void metaData(Uri uri){
        ...
        int durationTotal = Integer.parseInt(listSongs.get(position)) / 1000;
